...
const Pokedex = () => {
    ...
    return (
        <div
            ref={pokedexRef}
            className="pokedex grid grid-cols-[175px_1fr_20px] grid-rows-[94px_1fr] w-full h-full max-h-[920px] max-w-[500px] m-auto bg-pokedex bg-img-header bg-no-repeat bg-position rounded-[10px] relative border border-black overflow-hidden before:content-[''] before:block before:absolute before-t-0 before:w-full before:h-[95px] before:bg-img-header before:bg-left-bottom before:bg-no-repeat "
        >
